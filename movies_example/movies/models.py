...
'''
class PaymentP200701(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'payment_p2007_01'


class PaymentP200702(models.Model):
    payment_id = models.AutoField()
    customer = models.ForeignKey(Customer, models.DO_NOTHING)
    staff = models.ForeignKey('Staff', models.DO_NOTHING)
    rental = models.ForeignKey('Rental', models.DO_NOTHING)
    ...
    class Meta:
        managed = False
        db_table = 'payment_p2007_02'


class PaymentP200703(models.Model):
    payment_id = models.AutoField()
    customer = models.ForeignKey(Customer, models.DO_NOTHING)
    staff = models.ForeignKey('Staff', models.DO_NOTHING)
    rental = models.ForeignKey('Rental', models.DO_NOTHING)
    ...
    class Meta:
        managed = False
        db_table = 'payment_p2007_03'


class PaymentP200704(models.Model):
    payment_id = models.AutoField()
    customer = models.ForeignKey(Customer, models.DO_NOTHING)
    staff = models.ForeignKey('Staff', models.DO_NOTHING)
    rental = models.ForeignKey('Rental', models.DO_NOTHING)
    ...
    class Meta:
        managed = False
        db_table = 'payment_p2007_04'


class PaymentP200705(models.Model):
    payment_id = models.AutoField()
    customer = models.ForeignKey(Customer, models.DO_NOTHING)
    staff = models.ForeignKey('Staff', models.DO_NOTHING)
    rental = models.ForeignKey('Rental', models.DO_NOTHING)
    ...
    class Meta:
        managed = False
        db_table = 'payment_p2007_05'


class PaymentP200706(models.Model):
    payment_id = models.AutoField()
    customer = models.ForeignKey(Customer, models.DO_NOTHING)
    staff = models.ForeignKey('Staff', models.DO_NOTHING)
    rental = models.ForeignKey('Rental', models.DO_NOTHING)
...
class Staff(models.Model):
    ...
    address = models.ForeignKey(Address, models.DO_NOTHING)
    email = models.CharField(max_length=50, blank=True, null=True)
    store = models.ForeignKey('Store', models.DO_NOTHING, related_name='store')
